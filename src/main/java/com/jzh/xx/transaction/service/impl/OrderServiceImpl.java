...
public class OrderServiceImpl implements OrderService {
    ...
    public Long create(Long userId, Long expressId) {
        ...
        //获取商家id
        //BigInteger sellerId = sellerMapper.select(sellerId);
    ...
    public void updateOrder(ShopOrder order) {
        ...
        //System.out.println(shopOrderMapper.selectByExample(order.getId()));
        System.out.println("-------------------------------------");
        int i = shopOrderMapper.updateByExampleSelective(order,example);
